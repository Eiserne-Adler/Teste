...
public:
	Interface()
	{
		...
		m_throttlePosition1 = m_api.pfn_ed_cockpit_get_parameter_handle("FM_THROTTLE_POSITION1"); //
		m_engineThrottlePosition1 = m_api.pfn_ed_cockpit_get_parameter_handle("FM_ENGINE_THROTTLE_POSITION1"); //
		m_engineIgnition1 = m_api.pfn_ed_cockpit_get_parameter_handle("FM_IGNITION1"); //
		m_engineBleedAir1 = m_api.pfn_ed_cockpit_get_parameter_handle("FM_BLEED_AIR1");
	...
	inline void setThrottlePosition1(double number) //
	{
		setParamNumber(m_throttlePosition1, number); //
	}
	...
	inline double getEngineThrottlePosition1() //
	{
		return getParamNumber(m_engineThrottlePosition1);//
	}
	...
	inline double getBleedAir1() //
	{
		return getParamNumber(m_engineBleedAir1); //
	}
	...
	inline double getIgnition1() //
	{
		return getParamNumber(m_engineIgnition1); //
	}
...
private:
	...
	void* m_engineThrottlePosition1 = NULL;  //
	void* m_engineBleedAir = NULL; //
	void* m_engineIgnition = NULL; //
	void* m_engineIgnition1 = NULL; //
	void* m_engineBleedAir1 = NULL; //
